...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: '入口で決めるのは 3 つ。適用する基準（一般開示基準／気候関連開示基準／実務対応基準）、報告の範囲（連結範囲とバリューチェーン）、そしてどの課題に重要性があるか。ここが決まらないと、そもそもどの要求事項を評価対象にするのかが定まりません。未完了のまま先へ進めることは止めませんが、決まっていないことは表示し続けます。',
    lookAt:
      '3 項目の完了・未完了と、未完了のときに「次に何をすればよいか」が書いてあること。確定は人の操作でのみ行われ、内容を変えると確定は取り消されます。',
